author: Hank Spencer
summary: This Codelab will walk you through how to get started using Solace Distributed Tracing with Context Propagation via the Broker UI
id: dt-otel-pubsub-ui
tags: 
categories: Solace, Opentelemetry
environments: Web
status: Published
feedback link: https://github.com/SolaceDev/solace-dev-codelabs/blob/master/markdown/dt-otel-pubsub-ui
...
You can (generally) configure the Solace PubSub+ broker using three different methods; this codelab uses the Broker UI for configuration. Additional codelabs are available for broker
management via the CLI and the SEMP API V2.
