...
We'll then get your code to connect to the broker. This introduces the _session_ concept.
...
In the Client Connections Screen, you should see a list of the client connections for your broker. Since this is a _native_ connection, it will appear in the **Solace Clients** tab: here's what I saw:
...
The way nearly all asynchronous programming models deal with this is via a _callback_, specifying some code to be executed when the event occurs.
...
Run TopicSubscriber, and _publish_ a message using Try-Me!
...
Let's start with Java. Just like receiving messages, where we have a _Message Consumer_, we need to create a **Message Producer**. Looking at line 69 of **TopicPublisher.java**, you can see how this object is created:
