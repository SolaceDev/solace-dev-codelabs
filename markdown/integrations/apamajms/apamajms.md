...
* [Apama Streaming Analytics Documentation](https://documentation.softwareag.com/)
* [Connecting Apama Applications to External Components](https://documentation.softwareag.com/)
...
From [Apama Streaming Analytics Documentation](https://documentation.softwareag.com/), there are details on how to develop Apama applications.
...
Starting up Apama correlator in development is done from Apama Workbench. For server deployment, please see From [Deploying and Managing Apama Applications](https://documentation.softwareag.com/).
